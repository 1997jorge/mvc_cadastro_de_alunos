...
namespace MvcCadastro.Controllers
{
    ...
    {
        private readonly MvcCadastroContext _context;

        public CadastroController(MvcCadastroContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,RG")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,RG")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
